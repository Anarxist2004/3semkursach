...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CMy3semkursachView), CSize(0, 0), pContext);

	SetActiveView((CView*)m_wndSplitter.GetPane(0, 1));

	((CMy3semkursachDoc*)GetActiveDocument())->pTree = (CMyTreeView*)m_wndSplitter.GetPane(0, 0);
	((CMy3semkursachDoc*)GetActiveDocument())->pView = (CMy3semkursachView*)m_wndSplitter.GetPane(0, 1);
	((CMyTreeView*)m_wndSplitter.GetPane(0, 0))->m_pDoc = ((CMy3semkursachDoc*)GetActiveDocument());
