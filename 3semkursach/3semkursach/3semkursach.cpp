...
// 3semkursach.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMy3semkursachApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMy3semkursachApp::OnAppAbout)
...
// Создание CMy3semkursachApp

CMy3semkursachApp::CMy3semkursachApp() noexcept
{
	...
	SetAppID(_T("My3semkursach.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CMy3semkursachApp

CMy3semkursachApp theApp;


// Инициализация CMy3semkursachApp

BOOL CMy3semkursachApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMy3semkursachDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CMy3semkursachView));
	if (!pDocTemplate)
		return FALSE;
...
int CMy3semkursachApp::ExitInstance()
{
...
// Обработчики сообщений CMy3semkursachApp
...
void CMy3semkursachApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
